...
# OCLP7 D97HB — ASUS2 post-D97GS Root Patch, pre-reboot audit after CLEAN Restore baseline.
...
OUT="$HOME/Desktop/OCLP7_D97HB_POST_D97GS_PRE_REBOOT_${STAMP}"
REPORT="$OUT/D97HB_REPORT.txt"
MNT="/private/tmp/OCLP7_D97HB_MNT_$$"
mkdir -p "$OUT" "$MNT"
MOUNTED=0
...
fail(){ echo "D97HB_STATUS=FAIL"; echo "D97HB_REASON=$*"; echo "D97HB_REPORT=$REPORT"; exit 1; }

cat <<'HDR'
===== OCLP7 D97HB — POST D97GS / PRE REBOOT AUDIT AFTER CLEAN RESTORE =====
ROOT_PATCH=NO
RESTORE=NO
SYSTEM_WRITE=NO
...
echo "D97HB_ACTIVE_SERVICE_SHA256=$ACTIVE_SERVICE_SHA"
...
echo "D97HB_ACTIVE_CORE_SHA256=$ACTIVE_CORE_SHA"
echo "D97HB_ACTIVE_CORE_BYTES=$ACTIVE_CORE_BYTES"
...
echo "D97HB_ACTIVE_SNAPSHOT_NATIVE=PASS"
...
echo "D97HB_OFFICIAL_HELPER_SHA256=$HELPER_SHA"
echo "D97HB_OFFICIAL_HELPER_TEAM=$HELPER_TEAM"
...
echo "D97HB_OFFICIAL_HELPER_RESTORED=PASS"
...
echo "D97HB_LOCAL_METALLIB_COUNT=$LOCAL_COUNT"
echo "D97HB_LOCAL_CORE_SHA256=$LOCAL_CORE_SHA"
echo "D97HB_LOCAL_CORE_BYTES=$LOCAL_CORE_BYTES"
...
echo "D97HB_ACTIVE_ROOT_DEVICE=$ROOT_ID"
echo "D97HB_BASE_SYSTEM_DEVICE=$BASE_ID"
...
echo "D97HB_PATCHED_SERVICE_SHA256=$PATCHED_SHA"
echo "D97HB_PATCHED_SERVICE_BYTES=$PATCHED_BYTES"
...
print(f'D97HB_PATCHED_P1_OFFSET=0x{off:x}')
print('D97HB_PATCHED_P1_POSTIMAGE='+got.hex())
print('D97HB_PATCHED_P1_POSTIMAGE_MATCH=' + ('PASS' if got==exp else 'FAIL'))
if got != exp: raise SystemExit(2)
PY

echo "D97HB_PATCHED_SERVICE_P1=PASS"
...
echo "D97HB_PATCHED_METALLIB_EXACT=$EXACT"
echo "D97HB_PATCHED_METALLIB_MISSING=$MISSING"
echo "D97HB_PATCHED_METALLIB_DIFFERENT=$DIFFERENT"
...
echo "D97HB_PATCHED_CORE_SHA256=$PATCHED_CORE_SHA"
echo "D97HB_PATCHED_CORE_BYTES=$PATCHED_CORE_BYTES"
echo "D97HB_PATCHED_CORE_MAGIC=$PATCHED_CORE_MAGIC"
...
echo "D97HB_PATCHED_METALLIB_LAYER=PASS"

printf '\n===== FINAL =====\n'
echo "D97HB_STATUS=PASS_PRE_REBOOT_AUDIT"
echo "D97HB_ACTIVE_SNAPSHOT=NATIVE_TAHOE_UNCHANGED"
echo "D97HB_PATCHED_P1=STRUCTURAL_SEMANTIC_PASS_PRE_REBOOT"
echo "D97HB_PATCHED_METALLIBS=180_OF_180_EXACT"
echo "D97HB_OFFICIAL_HELPER=RESTORED_PASS"
echo "D97HB_NEXT=VESA_REBOOT_ONLY_AFTER_REVIEW"
echo "D97HB_REBOOT=NO"
echo "D97HB_REPORT=$REPORT"
