...
EL_GEN_SHA="b0d48e176e2b1e9b2bafa902007b80800963108c13d2d76f51fd578baa992637"
...
[[ "$(/usr/bin/shasum -a 256 "${WORK}/D97EL_generator.py" | awk '{print $1}')" == "${EL_GEN_SHA}" ]] || die "D97EL_generator_sha_mismatch"
...
[[ "${SRC_SHA}" == "${EL_SOURCE_SHA}" ]] || die "D97EL_source_sha_mismatch"
